      ...
      <div className="w-full">
        ...
        <div className="flex justify-center mb-10 pt-2">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-1 flex items-center gap-1">
            <button className="flex items-center gap-2 px-6 py-2.5 text-[15px] font-semibold text-gray-500 hover:text-gray-700 rounded-xl transition-all">
            ...
            <button className="flex items-center gap-2 px-6 py-2.5 text-[15px] font-semibold text-green-700 bg-white shadow-sm border border-gray-100 rounded-xl transition-all">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          <div className="lg:col-span-2 [&>div]:h-full [&>div]:flex [&>div]:flex-col [&>div]:justify-center">
            <StatCard theme="green" title="Today's Revenue" value="120,450" currency="DZD" change="+15% vs yesterday" />
          </div>
          <div className="flex flex-col gap-6">
            <StatCard title="Current Month Revenue" value="1340,000" currency="DZD" change="→ On track" />
            <StatCard title="Current Annual Revenue" value="1340,000" currency="DZD" change="↗ +22%" />
          </div>
        </div>
