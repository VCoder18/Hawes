    ...
    <div className="space-y-6">
          ...
          content={
            <div className="flex flex-wrap gap-2">
              {allActivities.map((activity) => (
                <span
                  key={activity}
                  className="bg-bg-[#ff5900] text-text-[#00b70d] px-3 py-1 rounded-full text-sm break-words max-w-full"
                >
                  {activity}
                </span>
              ))}
        ...
        <ReviewSection
          ...
          content={
            <div className="space-y-2 text-sm break-words">
              ...
              <p className="font-semibold border-t border-[#e2e8f0] pt-2 break-words">
                <span>Net Revenue:</span> {netRevenue.toLocaleString()} DZD
              </p>
            </div>
          }
        />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-6 border-t border-[#e2e8f0]">
        <button
          ...
          className="flex items-center justify-center gap-2 px-6 py-4 border-2 border-[#e2e8f0] rounded-xl font-medium text-text-[#00b70d] hover:bg-bg-[#ff5900] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
        >
        ...
        <button
          onClick={onPublish}
          disabled={isSubmitting}
          className="flex items-center justify-center gap-2 px-6 py-4 bg-[#00b70d] text-white rounded-xl font-medium hover:bg-[#00b70d]-hover transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
        >
